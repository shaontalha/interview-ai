        ...
        {loading && (
          <div className="home__loading-overlay">
            <div className="home__loading-card">
              ...
              <p className="home__loading-title">
            ...
            <div className="input-group">
              ...
              <label
                className={`file-label${
                  resumeFile ? " file-label--uploaded" : ""
                }`}
                htmlFor="resume"
                onDrop={onResumeDrop}
              ...
              >
                ...
                {!resumeFile && (
                  <span className="file-label__hint">
                    PDF or DOCX (Max 5MB)
                  </span>
                )}
              </label>
        ...
        {reports && reports.length > 0 && (
          <div className="recent-reports">
            ...
            <div className="recent-reports__header">
              <h2 className="recent-reports__title">
                Recent Reports
              </h2>
              ...
              {reports.map((r) => (
                ...
                >
                  <div className="report-card__top">
                    ...
                    <span
                      className={`report-card__score report-card__score--${
                        r.matchScore >= 70
                          ? "high"
                          : r.matchScore >= 40
                          ? "mid"
